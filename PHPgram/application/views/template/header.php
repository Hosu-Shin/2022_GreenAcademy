                    ...
                    <nav class="d-flex flex-grow-1 flex-row justify-content-end">
                        ...
                        <span class="position-relative">                                
                                <svg id="dmIcon" aria-label="다이렉트 메시지" class="_8-yf5 pointer" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                                    ...
                                    </line><polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></polygon></svg>                                
                        ...
                        <div class="d-inline-flex dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navDropdiwnMenuLink">
                                ...
                                <li><a href="/user/logout" class="dropdown-item">로그아웃</a>
                            </ul>
                        </div>
                    </nav>
                </div>
